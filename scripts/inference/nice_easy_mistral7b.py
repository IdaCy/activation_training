...
PROMPT_FILE = (
    ...
    or "prompts/easy_nice.csv"
)

OUTPUT_DIR = (
    os.environ.get("OUTPUT_DIR")
    or globals().get("OUTPUT_DIR")
    or "output/extractions/mistral7b/easy_nice"
)
...
LOG_FILE = (
    ...
    or "logs/inf_mistral7b_easy_nice_progress.log"
)
ERROR_LOG = (
    os.environ.get("ERROR_LOG")
    or globals().get("ERROR_LOG")
    or "logs/inf_mistral7b_easy_nice_error.log"
)
