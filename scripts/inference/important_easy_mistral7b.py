...
PROMPT_FILE = (
    ...
    or "prompts/easy_important.csv"
)

OUTPUT_DIR = (
    os.environ.get("OUTPUT_DIR")
    or globals().get("OUTPUT_DIR")
    or "output/extractions/mistral7b/easy_important"
)
...
EXTRACT_ATTENTION_LAYERS = (
    ...
    or globals().get("EXTRACT_ATTENTION_LAYERS", [0, 5, 10, 15, 20, 25, 30, 31])
)
...
LOG_FILE = (
    ...
    or "logs/inf_mistral7b_easy_important_progress.log"
)
ERROR_LOG = (
    os.environ.get("ERROR_LOG")
    or globals().get("ERROR_LOG")
    or "logs/inf_mistral7b_easy_important_error.log"
)
